...
from lamner_utils.utils import set_seed, init_weights, print_log, get_max_lens, count_parameters, calculate_bleu, write_files, epoch_time
...
def run_seq2seq(batch_size= 4, embedding_size= 512, hidden_dimension = 512, dropout = 0.5, epochs = 10, static = False, learning_rate = 0.01, infer = False):
  ...
  path = "data_seq2seq/" #reference data path
  output_dir = "predictions/codebert/"
